...
router.get('/api/dorms/facilities/pending', verifyToken, dormController.getFacilityRequests_api);
router.put('/api/dorms/facility/approve/:fac_id', verifyToken, dormController.approveFacilityRequest_api);
